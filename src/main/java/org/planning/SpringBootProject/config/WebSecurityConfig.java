    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/admin/order","/admin/product", "/admin/deleteProduct", "/admin/orderList", "/admin/loadData", "/admin/manageAccount", "/admin/activeAccount", "admin/deleteAccount", "/admin/editAccount", "/admin/addAccount", "/admin/manageProduct", "/admin/unlockProduct", "/admin/searchInManageProduct", "/admin/searchAccountByAdmin")
                        .hasRole("MANAGER")
